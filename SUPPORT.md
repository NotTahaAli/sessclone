...
- **A bug** — open an [issue](https://github.com/NotTahaAli/sessclone/issues/new/choose).
...
- **The docs** — <https://sessclone.com/docs>, and the `docs/` folder in this
...
SessClone is maintained by one person. Answers come when they come; a clear
report with the versions filled in gets one sooner.
