 ...
 * mid-request and reported as cancelled in the session. Each request is bounded
 * by it too, not only the gaps between them. What this cuts off the next `Stop`
 * or `SessionStart` sweep sends, from the same cursors.
 */
const FLUSH_BUDGET_MS = 8000

const deadline = deadlineIn(FLUSH_BUDGET_MS)
