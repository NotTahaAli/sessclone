...
- [x] `wholeStream` and the checksum abort are unit-tested in Node (in 132's `data.test.ts`, not duplicated here)
- [x] The button's choice between picker and Blob is a small pure function with a unit test
